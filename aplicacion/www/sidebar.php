  ...
  <div class="sidebar-content">
    ...
    <div class="sidebar-item sidebar-menu">
      <ul>
        ...
        <li class="sidebar-dropdown boton-active">
          <a href="#">
          ...
          <div class="sidebar-submenu">
            <ul>
              <li>
                <a href="dash-carpeta.php">Todas las Carpetas</a>
              </li>
              <li>
                <a href="#">Carpeta 2</a>
              </li>
        ...
        <li class="sidebar-dropdown boton-active">
          ...
          <div class="sidebar-submenu">
            <ul>
              <li>
                <a href="dash-proyecto.php">Todos los Proyectos</a>
              </li>
              <li>
                <a href="#">Proyecto 2</a>
              </li>
        ...
        <li class="sidebar-dropdown boton-active">
          ...
          <div class="sidebar-submenu">
            <ul>
              <li>
                <a href="dash-archivo.php">Todos los Archivos</a>
              </li>
              <li>
                <a href="#">Archivo 2</a>
              </li>
        ...
        <li class="sidebar-dropdown boton-active">
          ...
          <div class="sidebar-submenu">
            <ul>
              <li>
                <a href="#">Todos los Planes<span class="badge badge-pill badge-success">Pro</span></a>
              </li>
              <li>
                <a href="#">Profesional<span class="badge badge-pill badge-success">Pro</span></a>
              </li>
              <li>
                <a href="#">Básico<span class="badge badge-pill badge-warning">Básico</span></a>
              </li>
              <li>
                <a href="#">Gratis<span class="badge badge-pill badge-warning">Gratis</span></a>
              </li>
            </ul>
          </div>
        </li>
